...
namespace SchemesWebApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index(string LangCode="en")
        {
            ...
            schemesCustomerLabelsVM = GetLabelTextsBYLangCode(LangCode);
        ...
        public IActionResult GetSchemesList(string name,string langCode="en")
        {
            try
            {
                ...
                schemesCustomerLabelsVM.SchemeDetailList = new List<SchemeDetails>();
                schemesCustomerLabelsVM.SchemeDetailList = list;
                return View(schemesCustomerLabelsVM);
            }
            catch (Exception ex)
            {
        ...
        public SchemesCustomerLabelsVM GetLabelTextsBYLangCode(string LangCode="en")
        {
            SchemesCustomerLabelsVM schemesCustomerLabelsVM = new SchemesCustomerLabelsVM();
            if (LangCode == "en")
            {
            ...
            return schemesCustomerLabelsVM;
        }
